...
public class DriveConstants {
  public static final double maxSpeedMetersPerSec = 2.87059;
  ...
  public static final double driveKs = 0.16935;
  public static final double driveKv = 0.14558;
  public static final double driveSimP = 0.00;
  public static final double driveSimD = 0.0;
  public static final double driveSimKs = .16935;
  public static final double driveSimKv = 0.14558;
  ...
  public static final double turnSimP = 2.0;
  public static final double turnSimD = 0.0;
  public static final double turnPIDMinInput = 0; // Radians
  public static final double turnPIDMaxInput = 2 * Math.PI; // Radians

  // PathPlanner configuration
  public static final double robotMassKg = 75;
  public static final double robotMOI = 8.0;
